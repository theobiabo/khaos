...
The Node.js runtime does not guarantee that every copied buffer is immediately erased from memory. If strict memory control is required, keep the operation inside the Rust boundary and review the implementation for zeroization.
