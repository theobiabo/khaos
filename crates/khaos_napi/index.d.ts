...
export declare function analyzeEntropy(input: Buffer): EntropyReport
...
export declare function generateBytes(input: Buffer, length: number): Buffer

export declare function replayBytes(seed: Buffer, input: Buffer, length: number): Buffer
